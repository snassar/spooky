...
- **`template-structure.schema.hcl`**: Common template structure definitions for all template-related schemas
...
- **`template-context.schema.hcl`**: Enhanced context schema with composition pattern
- **`template-functions.schema.hcl`**: Enhanced functions schema with composition pattern  
- **`template-metadata.schema.hcl`**: Enhanced metadata schema with composition pattern
