...
// Aligns with template-context.schema.hcl schema
type TemplateContext struct {
	// Project configuration
	Project *spookytypesconfig.ProjectConfig `hcl:"project,optional" json:"project"`

	// Machine facts (from facts.db or JSON)
	Facts map[string]interface{} `hcl:"facts,optional" json:"facts"`

	// Inventory information
	Machines []*spookytypesconfig.Machine `hcl:"machines,optional" json:"machines"`

	// Actions configuration
	Actions []*spookytypesconfig.Action `hcl:"actions,optional" json:"actions"`
	...
	// Variables context
	Variables *spookytypesvariables.VariableContext `hcl:"variables,optional" json:"variables"`
