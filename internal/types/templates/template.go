...
// Aligns with template-metadata.schema.hcl schema
type Template struct {
	// Template metadata (from template-metadata.schema.hcl)
...
// Aligns with template-metadata.schema.hcl variables definition
...
// Aligns with template-metadata.schema.hcl metadata definition
