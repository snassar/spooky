...
metadata {
  ...
  schema_type = "variables-hcl"
  schema_name = "Variables HCL Schema"
  last_updated = "2024-01-01"
  compatibility = ["0.20250809.0"]
  description = "Schema for variables stored in HCL format - composes the base variables structure with HCL-specific storage rules"
