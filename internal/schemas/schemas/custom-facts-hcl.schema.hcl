...
metadata {
  ...
  schema_type = "custom-facts-hcl"
  schema_name = "Spooky Custom Facts HCL Schema"
  last_updated = "2024-01-01"
  compatibility = ["0.20250809.0"]
  description = "Schema for custom facts stored in HCL format in /etc/spooky/facts/ on target machines"
