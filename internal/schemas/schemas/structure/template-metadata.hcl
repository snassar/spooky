...
metadata {
  ...
  schema_type = "template-metadata"
  schema_name = "Template Metadata Schema"
  last_updated = "2024-01-01"
  compatibility = ["0.20250809.0"]
  description = "Enhanced template metadata schema with composition pattern - includes template-structure base and metadata-specific features"
