...
import (
	...
	secretstypes "spooky/internal/secrets/types"
)

// MachineSecrets represents secrets associated with a machine
type MachineSecrets struct {
	MachineName string                                 `json:"machine_name"`
	Secrets     map[string]secretstypes.EncryptedValue `json:"secrets"`
...
type MachineKeys struct {
	...
	PrivateKey  secretstypes.EncryptedValue `json:"private_key,omitempty"`
	Created     time.Time                   `json:"created"`
